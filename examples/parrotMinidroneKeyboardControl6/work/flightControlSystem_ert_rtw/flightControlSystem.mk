...
## Generated on : Fri Feb 11 21:43:16 2022
...
START_DIR                 = C:/Users/navin/MATLAB/Projects/examples/parrotMinidroneKeyboardControl6/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/SHARED~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/parrot/include -I$(START_DIR)/flightControlSystem_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
OBJS = MW_TCPSendReceive.o rsedu_image.o flightControlSystem.o flightControlSystem_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/shared_linuxservices/src/TCPSendReceive/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/shared_linuxservices/src/TCPSendReceive/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_TCPSendReceive.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/shared_linuxservices/src/TCPSendReceive/MW_TCPSendReceive.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rsedu_control.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/parrot/src/rsedu_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rsedu_of.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/parrot/src/rsedu_of.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rsedu_vis.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/parrot/src/rsedu_vis.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ptimer.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/parrot/src/ptimer.c
	$(CC) $(CFLAGS) -o "$@" "$<"


controlCommand.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/parrot/src/controlCommand.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_extrathreads.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/parrot/src/mw_extrathreads.c
	$(CC) $(CFLAGS) -o "$@" "$<"
