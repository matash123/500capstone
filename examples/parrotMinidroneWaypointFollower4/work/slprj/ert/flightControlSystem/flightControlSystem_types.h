...
#endif
#ifndef struct_tag_VcoN9MaTNSOSOTUznpbAdE
#define struct_tag_VcoN9MaTNSOSOTUznpbAdE
struct tag_VcoN9MaTNSOSOTUznpbAdE { int32_T isInitialized ; hpeep04rve
inputVarSize [ _nfvdmbxYkVXzXnpHyWwmg2 ] ; real_T LookaheadDistance ; real_T
WaypointIndex ; real_T NumWaypoints ; real_T WaypointsInternal [
_S7jOy2WqKYdJfeq_c2tim_ ] ; boolean_T LastWaypointFlag ; boolean_T StartFlag
; real_T InitialPose [ _g7WFphbd05O6bEjctOzUc1 ] ; real_T LookaheadFactor ;
uint8_T LookaheadDistFlag ; } ;
#endif
#ifndef typedef_fhgcsffear
#define typedef_fhgcsffear
typedef struct tag_VcoN9MaTNSOSOTUznpbAdE fhgcsffear ;
#endif
...
#endif
typedef struct eolxfdqn1d_ eolxfdqn1d ; typedef struct nky1inzkgw_ nky1inzkgw
; typedef struct nkcqldbdpt_ nkcqldbdpt ; typedef struct ezhog2cu2d_
