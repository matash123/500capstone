...
struct tag_VcoN9MaTNSOSOTUznpbAdE
{
  int32_T isInitialized;
  cell_wrap_flightControlSystem_T inputVarSize[3];
  real_T LookaheadDistance;
  real_T WaypointIndex;
  real_T NumWaypoints;
  real_T WaypointsInternal[27];
...
#endif                                 /* struct_tag_VcoN9MaTNSOSOTUznpbAdE */

#ifndef typedef_uav_sluav_internal_system_WaypointFollower_flightControlSyste_T
#define typedef_uav_sluav_internal_system_WaypointFollower_flightControlSyste_T

typedef struct tag_VcoN9MaTNSOSOTUznpbAdE
  uav_sluav_internal_system_WaypointFollower_flightControlSyste_T;

#endif
   /* typedef_uav_sluav_internal_system_WaypointFollower_flightControlSyste_T */
