...
## Generated on : Mon Nov 29 15:55:11 2021
## Final product: ./flightControlSystem_rtwlib.a
...
START_DIR                 = C:/Users/navin/MATLAB/Projects/examples/parrotMinidroneKeyboardControl/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = flightControlSystem_rtwlib.a
...
PRODUCT = ./flightControlSystem_rtwlib.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/SHARED~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/parrot/include -I$(START_DIR)/slprj/ert/flightControlSystem -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
OBJS = MW_TCPSendReceive.o rsedu_image.o flightControlSystem.o
...
%.o : $(START_DIR)/slprj/ert/flightControlSystem/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/flightControlSystem/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
flightControlSystem.o : $(START_DIR)/slprj/ert/flightControlSystem/flightControlSystem.c
	$(CC) $(CFLAGS) -o "$@" "$<"
